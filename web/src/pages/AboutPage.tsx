    ...
    <>
      <section className="border-b border-line">
        <Container className="py-16 md:py-24">
          <p className="text-[12px] text-ink-3">About Linemate</p>
          <h1 className="mt-5 max-w-[18ch] text-display font-bold text-ink">
            A box-office for the <span className="text-accent">curious.</span>
          </h1>
          ...
          <div className="grid grid-cols-2 gap-px overflow-hidden md:grid-cols-4">
            {STATS.map(([label, value]) => (
              <div key={label} className="px-2 py-10 text-center">
                <p className="text-[2rem] font-medium text-ink">{value}</p>
      ...
      <section>
        <Container className="py-16 md:py-20">
          <h2 className="text-h2 font-semibold text-ink">What we believe</h2>
          <div className="mt-8 grid gap-px overflow-hidden rounded-md border border-line bg-line md:grid-cols-3">
            {VALUES.map(([title, body]) => (
              <div key={title} className="bg-paper-2 p-7">
                <h3 className="text-[1.4rem] font-medium leading-tight text-ink">{title}</h3>
      ...
      <section className="border-t border-line bg-ink-bg text-paper-on-ink">
        <Container className="py-16 text-center md:py-20">
          <h2 className="text-display font-bold">
            Go out <span className="text-accent">more.</span>
          </h2>
